...
@Slf4j
public class GbExportSignController {
    @Value("${spark.business.gbExportSign.jarPath}")
    private String jarPath;
    @Value("${spark.business.gbExportSign.mainClass}")
    private String mainClass;
    @Value("${spark.business.gbExportSign.master}")
    private String master;
    @Value("${spark.business.gbExportSign.deployMode}")
    private String deployMode;
    @Value("${spark.business.gbExportSign.appName}")
    private String appName;
    @Value("${spark.business.gbExportSign.queue}")
    private String queue;
    @Value("${spark.business.gbExportSign.driverMemory}")
    private String driverMemory;
    @Value("${spark.business.gbExportSign.executorMemory}")
    private String executorMemory;
    @Value("${spark.business.gbExportSign.kryoserializerBufferMax}")
    private String kryoserializerBufferMax;

    @ApiResponse(code = 200, message = "执行状态")
    @ApiOperation(value = "提交国标历史信号导出JOB", notes = "异步导出数据")
    @PostMapping("inside/spark/export-sign-gb-job")
